/* eslint-disable @typescript-eslint/triple-slash-reference, @typescript-eslint/naming-convention, @typescript-eslint/no-explicit-any, @typescript-eslint/ban-types */
...
declare namespace Whistle {
  ...
  type PluginReqHandler = (
    buffer: Buffer | null,
    next: (result?: PluginNextResult) => void,
    ctx?: PluginReqCtx,
  ) => void;
  type PluginResHandler = (
    buffer: Buffer | null,
    next: (result?: PluginNextResult) => void,
    ctx?: PluginResCtx,
  ) => void;
