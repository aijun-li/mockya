  ...
  function i(v, c) {
    ...
    return (
      ...
      (n.cn = function () {
        var s = n.fn,
          a = s.installing;
        n.tn > 0 || !b(a.scriptURL, n.sn.toString()) || performance.now() > n.un + 6e4
      ...
      (n.dn = function (s) {
        ...
        n.dispatchEvent(new g('controlling', { isExternal: u, originalEvent: s, sw: a, isUpdate: n.mn })),
          u || n.on.resolve(a);
      }),
      (n.gn =
        ((o = function (s) {
          ...
          return p(n.getSW(), function () {
            n.an.has(l) && n.dispatchEvent(new g('message', { data: a, originalEvent: s, ports: u, sw: l }));
          });
        }),
        function () {
              ...
              p(o.bn(), function (s) {
                ...
                return (
                  a &&
                    ...
                    Promise.resolve()
                      .then(function () {
                        o.dispatchEvent(new g('waiting', { sw: a, wasWaitingBeforeRegister: !0 }));
                      })
                      .then(function () {})),
